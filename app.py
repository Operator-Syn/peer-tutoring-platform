...
def create_app():
    ...
    # Trust proxy headers (Cloudflare / reverse proxy)
    ...
    from api.tutee_list import tutee_list  # ✅ from HEAD
    ...
    app.register_blueprint(tutee_list, url_prefix="/api/tutee-list")  # ✅ keep enabled
