...
import TutorNotesList from "../UploadNotes/TutorNotesList";
                    ...
                    >
                      ...
                      >
                        ...
                        <p style={{ fontSize: "0.9rem", color: "#555" }}>
                          ...
                          describe the incident truthfully and with as much
                          detail as possible. We will review the report and, if
                          warranted, impose appropriate consequences.
                        </p>
                          ...
                          <button
                            ...
                            onClick={async () => {
                              if (selectedReasons.length === 0 && reportDetails.trim() === "") {
                                toast.warn(
                                  "Please select at least one reason or add a description.",
                                  toastOpts
                                );
                                return;
                              }
