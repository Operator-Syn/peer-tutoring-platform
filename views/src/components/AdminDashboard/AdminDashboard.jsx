...
const AdminDashboard = () => {
    ...
    return (
        <div className={`admin-container ${showCorModal ? 'modal-open-custom' : ''}`}>
            ...
            <ToastContainer position="top-end" style={{ zIndex: 3000, position: 'fixed', top: '1rem', right: '1rem' }}>
                                    ...
                                    <div key={app.application_id} className="application-card">
                                        ...
                                        <div className="card-content-row">
                                            ...
                                            <div className="actions-section">
                                                <button className="btn-accept" onClick={() => openActionModal('APP', app, 'APPROVED')} disabled={app.status !== 'PENDING'}>Accept</button>
